...
class UserRouter {
    ...
    Routes() {
        ...
        this.router.put("/upload-image/:id", validateMongodbId_1.default, this.userAuth.Auth, this.imagesOperations.uploadMulter().single("image"), this.userValidation.imageDimension(), handelBodyError_1.default, this.userController.uploadImage);
